          ...
          <div class="card-body">
            <div class="card">
              <div class="card-header">
                <a href="<?= site_url('Menu/Addmenu') ?>" class="btn btn-outline-info btn-sm"> <i class="fa fa-plus-square"> Tambah Data</i></a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                    ...
                    $no=1;
                     foreach ($row as $key => $data) { ?>
                       <tr>
                        ...
                        <td><?= $data->menu?></td>
                        <td>
                        <a href="<?= site_url('Menu/edit/'. $data->id)?>" class="btn btn-warning btn-xs">
                            <i class="fas fa-edit"></i>
                          </a>

                          <a href="<?= site_url('Menu/delete/'. $data->id)?>" id="btn-hapus" class="btn btn-danger btn-xs">
