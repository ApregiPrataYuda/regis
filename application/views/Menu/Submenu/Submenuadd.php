    ...
    <div class="card-body">
      <form action="" method="post">
        <div class="row">
         ...
         <div class="col-md-3 <?= form_error('id') ? '' : null ?>">
          ...
          <div class="col-md-3 <?= form_error('title') ? '' : null ?>">
            ...
            <input type="text" name="title" value="<?= set_value('title'); ?>" class="form-control" placeholder="title submenu....">
          ...
          <div class="col-md-5 <?= form_error('url') ? '' : null ?>">
            ...
            <input type="text" name="url" value="<?= set_value('url'); ?>" class="form-control" placeholder="url submenu....">
       ...
       <div class="col-md-5 <?= form_error('icon') ? '' : null ?>">
            ...
            <input type="text" name="icon" value="<?= set_value('icon'); ?>" class="form-control" placeholder="icon submenu....">
